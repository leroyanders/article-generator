...
<head>
  ...
  <meta name="description"
    content="WEBSITE PRIVACY POLICY   Your privacy is important to us.  We have created this privacy policy to explain to you how we gather, use, and protect your personal information.  By using this website, you agree to the terms in this policy, so please read carefully.  If you don’t agree with these terms, please don’t use this">
  ...
  <script
    id="__st">var __st = { "a": 25085116462, "offset": -18000, "reqid": "d99ac78c-c24b-4296-aadb-2771af57e632", "pageurl": "www.indigocollagen.com\/pages\/privacy-policy", "s": "pages-48377724974", "u": "8318a8d130c2", "p": "page", "rtyp": "page", "rid": 48377724974 };</script>
  ...
  <script>window.ShopifyAnalytics = window.ShopifyAnalytics || {};
    ...
    var meta = { "page": { "pageType": "page", "resourceType": "page", "resourceId": 48377724974 } };
  ...
  <script class="analytics">(window.gaDevIds = window.gaDevIds || []).push('BwiEti');
    ...
    (function () {
      ...
      trekkie.ready(function () {
        ...
        window.ShopifyAnalytics.lib.page(null, { "pageType": "page", "resourceType": "page", "resourceId": 48377724974 });
    ...
    <div class="page-width">
      <div class="grid">
        <div class="grid__item medium-up--five-sixths medium-up--push-one-twelfth">
          <div class="section-header section-header--top-padded">
            <h3>
              <?php echo $ml['privacy-policy-title'];?>
            </h3>
          </div>

          <?php echo $ml['privacy-policy-conent'];?>
          <div class="rte bottom-padded">
            <?php echo $ml['privacy-policy-conent1'];?>

            <?php echo $ml['privacy-policy-conent2'];?>

            <?php echo $ml['privacy-policy-conent3'];?>

            <?php echo $ml['privacy-policy-conent4'];?>

            <?php echo $ml['privacy-policy-conent5'];?>

            <?php echo $ml['privacy-policy-conent6'];?>
            ...
            <table cellspacing="0" cellpadding="0" class="t1">
              <tbody>
                <?php echo $ml['privacy-policy-conent7-table-tr1'];?>

                <?php echo $ml['privacy-policy-conent7-table-tr2'];?>

                <?php echo $ml['privacy-policy-conent7-table-tr3'];?>

                <?php echo $ml['privacy-policy-conent7-table-tr4'];?>

                <?php echo $ml['privacy-policy-conent7-table-tr5'];?>
              </tbody>
            </table>

            <?php echo $ml['privacy-policy-conent8'];?>
