...
<head>
  ...
  <link rel="shortcut icon" href="img/favicon_32x32.png?v=1577736892" type="image/png">
  <title>BIO STRUCTURE LAB</title>
  <meta name="description"
    content="BIO STRUCTURE LAB is your trusted source for premium Bio Structure Lab Collagen+ powder for hair, skin, &amp; nails. Inspired by people, made by nature to elevate your wellness routine.">
  <meta name="description" content="BIO STRUCTURE LAB, Premium Bio Structure Lab Collagen+. Inspired by people, made by nature.">

  <meta property="og:site_name" content="BIO STRUCTURE LAB">
  <meta property="og:title" content="BIO STRUCTURE LAB">
  <meta property="og:type" content="website">
  <meta property="og:description"
    content="BIO STRUCTURE LAB is your trusted source for premium Bio Structure Lab Collagen+ powder for hair, skin, &amp; nails. Inspired by people, made by nature to elevate your wellness routine.">

  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="BIO STRUCTURE LAB">
  ...
  <link href="css/envoy.css?v=65619054672744971111111712954555" rel="stylesheet" type="text/css" media="all" />
  ...
  <script
    id="__st">var __st = { "a": 25085116462, "offset": -18000, "reqid": "84c55a8b-be43-4a84-8ce5-915899970937", "pageurl": "www.indigocollagen.com\/?fbclid=IwAR08vBvzFDJzh3HxdeON6EWh3DZdW7wNzsPwOMWpg9BnQtw-Wh6jnSpN29g", "u": "02a2a2224093", "p": "home" };</script>
  ...
  <script integrity="sha256-fnL7TRTwbWDFcwa4DcFG8Ozb5OTAlB9PNTe+5NVDFK8=" data-source-attribution="shopify.loadfeatures"
    defer="defer"
  ...
  <meta property="og:image" content="https:img/indigo.png?height=628&pad_color=fff&v=1577746367&width=1200" />
  <meta property="og:image:secure_url"
    content="https:img/indigo.png?height=628&pad_color=fff&v=1577746367&width=1200" />
...
<body class="template-index">
  ...
  <div id="shopify-section-promo-popup" class="shopify-section">
    <div class="promo-popup promo-popup__container" data-indigo-module="PromoPopup" data-indigo-event="true"
      ...
      <div class="promo-popup__dialog" style="background-image: url(img/promo-popup-image-1_974x.jpg?v=1589312227);"
        data-success-image="img/promo-popup-image-2_974x.jpg?v=1589316486">
          ...
          <div class="promo-popup__dialog-form">
            <form id="promo-popup-modal-email-signup" class="newsletter-signup__form"
              ...
              <input class="newsletter-signup__email" type="email" name="email"
                id="promo-popup-modal-email-signup-input" placeholder="YOUR EMAIL" aria-label="YOUR EMAIL"
                aria-required="true" autocorrect="off" autocapitalize="off" required>
              <div class="klaviyo_messages">
                <div class="success_message" style="display:none;">
                  <h5 class="newsletter-signup__response success" data-form-status>Thank you! We’ll only email when we
                    have something important to say.</h5>
                </div>
  ...
  <div id="shopify-section-header-envoy" class="shopify-section">
    ...
    <div class="header-envoy" data-indigo-module="HeaderEnvoy" data-indigo-args='{"test": "1"}' data-hover-menu-top>
      <header class="header-envoy__container">
        ...
        <div class="header-envoy__banner ">
          <div class="mobile_hide">

            <a href="" class="small">

              <span><?php echo $ml['free_sheeping'];?></span>
          ...
          <div class="desktop_hide">
            ...
            <a href="" class="small horizontalFlip">
        ...
        <div class="header-envoy__content banner-visible hover--alt" data-hover-menu-top-links>
                  ...
                  <li class=" megamenu">
                    <span class="site-nav__label">
                      <select onchange="changelang(this)">
                        <option value="de"><a href="/change_lang.php?lang=de">DE</a></option>
                        <option value="en"><a href="/change_lang.php?lang=en">EN</a></option>
                      </select>
                      </span>
                  </li>
  ...
  <main class="page-container" id="PageContainer">
    ...
    <div id="shopify-section-1591139649924" class="shopify-section">
      ...
      <section class="hero ">
        ...
        <!-- <img class="hero__image" src="img/IndigoMarineCollagenGiveBackHeader3_1024x1024.jpg?v=1639660751" data-scroll
          data-indigo-module="Hero"> -->
          <img class="hero__image" src="img/Group804.png" data-scroll
          data-indigo-module="Hero">

        <div class="text-section">
          <h1><?php echo $ml['collagen_title'];?></h1>
          <p class="hero__paragraph"><?php echo $ml['collagen_sub'];?></p>
          <div class="cta-arrow text-section__link">
            <a href="#blockThirdNew" class="cta-arrow__link" data-hover-color="">
              <div class="cta-arrow__text"><?php echo $ml['shop_now'];?></div>
              <svg class="cta-arrow__arrow" xmlns="http://www.w3.org/2000/svg" width="50" height="26" fill="none">
                <path d="M0 13h47M36.8 2.6c0.2 3.5 6.6 10.4 13 10.4M36.8 23.4c0.2-3.5 6.6-10.4 13-10.4"
                  style="stroke-width:2;stroke:#111;" />
              </svg>
            </a>
          </div>
    ...
    <div id="shopify-section-1607975876e81d31a5" class="shopify-section rose-bg">


      <section class="three-up">
        <h3 class="three-up__heading"><?php echo $ml['why_are_we'];?></h3>
        <div class="three-up__icons">

          <div class="three-up__block">
            <div class="three-up__icon-container">
              <img class="three-up__icon" src="img/Frame.png?v=1607977627" alt="">
            </div>

            <h4 class="three-up__block-heading">Bio Structure Lab Collagen+ <?php echo $ml['ab1'];?></h4>


            <p class="three-up__block-description"></p>

          </div>

          <div class="three-up__block">
            <div class="three-up__icon-container">
              <img class="three-up__icon" src="img/Frame_1.png?v=1607977678" alt="">
            </div>

            <h4 class="three-up__block-heading">Bio Structure Lab Collagen+ <?php echo $ml['ab2'];?></h4>
          ...
          <div class="three-up__block">
            <div class="three-up__icon-container">
              <img class="three-up__icon" src="img/Untitled-4_1.png?v=1607977699" alt="">
            </div>

            <h4 class="three-up__block-heading">Bio Structure Lab Collagen+ <?php echo $ml['ab3'];?></h4>
  ...
  <div id="blockThirdNew" class="blockThirdNew position-relative">
<div class="product-differentiator ">
    <div class="product-row">
      <div class="row-single-item row-single-item-left">
        <img class="box_top1" src="img/Group805.png" alt="">
      </div>
      <div class="row-single-item row-single-item-right">
        <div class="text-wrapper blockThirdNew__right">
          <?php echo $ml['max_about'];?>
          <h3 style="font-size: 60px; margin-top: 40px;" >39.99€</h3>
          <div class="mt-60">
          <a class="addCArd" style="position: relative; z-index: 2;" href="https://buy.stripe.com/test_bIYeWR0IB9zk5SobII"><?php echo $ml['buy_now'];?></a>
        </div>
        </div>
      </div>
    </div>
...
<?php echo $ml['ab4'];?>
    <div id="shopify-section-1597358571225" class="shopify-section">


      <?php echo $ml['five-icon-up'];?>

    </div>
    <div id="shopify-section-1591139703577" class="shopify-section new-index-section">
      <!-- product-differentiator -->
      <section class="product-differentiator">

        <div class="product-row image-right">
          <div class="row-single-item text rose-bg">
            <div class="text-wrapper">
              <span style="padding-top: 40px;">WHY Bio Structure Lab Collagen+</span>
              <?php echo $ml['tw1'];?>
              <?php echo $ml['tw2'];?>
              <?php echo $ml['tw3'];?>
            </div>
          ...
          <div class="row-single-item">
            <div class="img-container__full-width">

              <img class="scale" src="img/sache1.png?v=1614158953" style="position: relative;">
      ...
      <style>
        .product-differentiator .product-row .row-item.image.image--bg-alt,
        .product-differentiator .product-row .row-single-item.image.image--bg-alt {
          background-image: url(img/tundra-bg_1.jpg?v=1614158775);
        }
      </style>
      ...
      <!-- Bio Structure Lab Collagen+ Three Text Block -->
      <?php echo $ml['about-block'];?>

    <div id="shopify-section-1591139713668" class="shopify-section new-index-section">
      <!-- engagement -->
      <section class="hero engage ">
        <img src="img/ocean-pure-bg-dark_1.jpg?v=1614161349">
        <?php echo $ml['text-section'];?>
      </section>
      <!-- engagement -->
    </div>
      ...
      <section class="footer" id="footer">
        <footer>
          ...
          <div class="row align-items-center">
            <div class="col-xl-6 col-6-left-">
              <img class="box_top2" src="img/box_top2.png" alt="" class="">
            </div>
            <div class="col-xl-6 col-6-right">
              <?php echo $ml['footer-right'];?>
          </div>
          </div>
        </footer>
      </section>
      <div class="rose-bg bottomBlock">
        <div class="container">
        <div class="row justify-content-between" style="align-items: flex-end;">
      <div class="logo" style="color: #000; font-weight: bold;">
    
        <?php echo $ml['footer-copyright'];?>
      </div>
 
      <div class="terms">
      <?php echo $ml['footer-adress'];?>

      <?php echo $ml['footer-policy'];?>
...
-->
  ...
  <link href="https://bundle.thimatic-apps.com/theme_files/th-pb-style.css" rel="stylesheet" type="text/css"
    media="all" />
...
">
  <p style="font-size: 12px;">  <?php echo $ml['footer-cookie'];?></p>
  <button style="
  width: 100%;
  border-radius: 100px;
  border: none;
  ...
  padding: 10px;
  color:#fff;
" onclick="document.querySelector('.allow-coookie').style.display='none';"><?php echo $ml['footer-cookie-btn'];?></button>
</div>

<script>
function changelang(el){
  xhr = new XmlHttpRequest(); 
  xhr.send('GET', '/change_lang.php?lang='+ el.value); 
  xhr.onload = () => {
...
document.addEventListener('DOMContentLoaded', () => {
  document.querySelector('.header-envoy__nav--desktop').addEventListener('select', (el) => {xhr = new XmlHttpRequest(); xhr.send('GET', '/change_lang.php?lang='+ el.target.value); xhr.send();})});
</script>
